    ...
    var app = {
        ...
        handleRouting: function () {
            ...
            switch (route) {
                ...
                case 'my-profile':
                    ...
                    break;
                case 'services':
                    titleEl.textContent = 'Dental Services';
                    subEl.textContent = 'Service catalogue, pricing, durations and assigned dentists';
                    this.renderServices();
                    break;
                case 'blogs':
                    titleEl.textContent = 'Blog Management';
                    subEl.textContent = 'Publish dental health guides, articles and featured stories';
                    this.renderBlogs();
                    break;
                case 'reviews':
        ...
        renderServices: function () {
            ...
            container.innerHTML = `
                <div class="admin-card">
                    <div class="card-header">
                        <div>
                            <h3 class="card-title">Clinical Dental Services</h3>
        ...
        renderSettings: function () {
            ...
            document.getElementById('btn-export-backup').addEventListener('click', function () {
                ...
                a.download = 'lumora-dental-backup-' + new Date().toISOString().slice(0, 10) + '.json';
                ...
                <div style="display:flex; flex-direction:column; gap:16px;">
                    ...
                    <div class="admin-card" style="padding:16px;">
                        ...
                        <div style="font-size:13px; display:flex; flex-direction:column; gap:6px;">
                            <div><strong>Service:</strong> ${svc ? svc.name : 'Dental Consultation'}</div>
            ...
            var body = `
                <div style="background:#fff; color:#111; padding:24px; border-radius:var(--radius-md); font-family:sans-serif;" id="printable-receipt">
                    ...
                    <table style="width:100%; border-collapse:collapse; font-size:12px; margin-bottom:20px;">
                        ...
                        <tbody>
                            <tr>
                                <td style="padding:8px; border-bottom:1px solid #eee;">${svc ? svc.name : 'Dental Consultation'}</td>
        ...
        openServiceModal: function (svcId) {
            ...
            this.openModal(isEdit ? 'Edit Dental Service' : 'Add New Dental Service', body);
        ...
        openBlogModal: function (blogId) {
            ...
            this.openModal(isEdit ? 'Edit Blog Article' : 'Write Dental Article', body, 'modal-lg');
