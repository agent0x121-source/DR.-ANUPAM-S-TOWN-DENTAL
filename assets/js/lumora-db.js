/* ==========================================================================
   Dr. Anupam's Town Dental — Central Data Store & Management Database Engine
   --------------------------------------------------------------------------
...
(function (global) {
    ...
    var INITIAL_DATA = {
        clinic: {
            ...
            phoneSecondary: '+91 81266 43459',
            phoneE164: '918126643459',
            whatsapp: '+91 81266 43459',
            email: 'dranupamstowndental111@gmail.com',
            emergencyEmail: 'dranupamstowndental111@gmail.com',
            mapsUrl: 'https://maps.google.com/?cid=3426945284530272874',
            mapsEmbed: 'https://maps.google.com/maps?q=DR.%20ANUPAM%27S%20TOWN%20DENTAL%2C%20Macnair%20Road%2C%20Prem%20Nagar%2C%20Bareilly&output=embed',
            hours: {
                0: { open: '10:00', close: '18:00', brk: null, label: 'Sunday: 10:00 AM - 6:00 PM', closed: false },
                1: { open: '10:00', close: '20:00', brk: null, label: 'Monday: 10:00 AM - 8:00 PM', closed: false },
                2: { open: '10:00', close: '20:00', brk: null, label: 'Tuesday: 10:00 AM - 8:00 PM', closed: false },
                3: { open: '10:00', close: '20:00', brk: null, label: 'Wednesday: 10:00 AM - 8:00 PM', closed: false },
                4: { open: '10:00', close: '20:00', brk: null, label: 'Thursday: Closed', closed: true },
                5: { open: '10:00', close: '20:00', brk: null, label: 'Friday: 10:00 AM - 8:00 PM', closed: false },
                6: { open: '10:00', close: '20:00', brk: null, label: 'Saturday: 10:00 AM - 8:00 PM', closed: false }
            },
            transit: {
                metro: '',
                bus: '',
                landmark: 'Macnair Road — near Sood Dharam Kanta, opposite Major Nursing Home',
                parking: ''
            },
        ...
        doctors: [
            {
                ...
                email: 'dr.anupam@dranupamstowndental.in',
                specialization: 'Prosthodontist, Maxillofacial Prosthodontist & Oral Implantologist',
                qualification: 'MDS (Prosthodontics, Crown & Bridge and Maxillofacial Prosthetics), BDS',
                ...
                phone: '+91 81266 43459',
                bio: "Founder of Dr. Anupam's Town Dental. BDS with a Gold Medal and Honours from Kothiwal Dental College and Research Centre, Moradabad (2005), and MDS in Prosthodontics, Crown & Bridge and Maxillofacial Prosthetics with the student award of excellence from M.S. Ramaiah Dental College and Hospital, Bangalore (2011). His main area of contribution is Oral Implantology, and he has headed the Oral Implantology section at NHDCRI, Bilaspur. A recipient of national awards including the F.D. Mirza Award, with more than 25 national and international publications in peer-reviewed indexed journals, and a member of the Indian Prosthodontic Society and the Indian Dental Association.",
                ...
                schedule: {
                    ...
                    4: { open: '10:00', close: '20:00', closed: true },
            ...
            },
            {
                ...
                email: 'dr.shally@dranupamstowndental.in',
                specialization: 'Oral & Maxillofacial Pathologist and Endodontist',
                qualification: 'MDS (Oral & Maxillofacial Pathology), BDS',
                experience: 'Practising since 2008',
                department: 'Endodontics & Oral Pathology',
                image: 'assets/img/gen_team-image-6.jpg',
                phone: '+91 81266 43459',
                bio: 'Co-founder of the clinic. BDS with Honours from Kothiwal Dental College and Research Centre, Moradabad (2008) and MDS in Oral & Maxillofacial Pathology from the same institute (2011), with further certificate courses in Advanced Endodontics and Laser Dentistry. She has conducted research in Forensic Odontology and Oral Cancer as principal investigator, securing best paper awards at national conferences, and has more than 25 national and international publications. Her clinical focus is advanced endodontics.',
                languages: ['English', 'Hindi'],
            ...
            },
            {
                ...
                email: 'orthodontist@dranupamstowndental.in',
                ...
                phone: '+91 81266 43459',
                bio: 'The clinic works with dedicated orthodontists for the correction of irregular and mal-positioned teeth, using metal braces, ceramic braces and clear aligners.',
                languages: ['English', 'Hindi'],
            ...
            },
            {
                ...
                email: 'oralsurgeon@dranupamstowndental.in',
                ...
                phone: '+91 81266 43459',
                bio: 'The clinic maintains a team of oral surgeons for extractions, repair of fractured jaws and surgical excision of oral cysts and tumours, supported by a multidisciplinary team and a tie-up with a medical hospital for emergencies.',
                languages: ['English', 'Hindi'],
        ...
        services: [
            {
                ...
                tagline: 'Fixed replacement teeth, rooted in the jaw',
                description: 'Dental implants are titanium screws placed in the jaw with minor surgery to replace missing teeth. The clinic has practised implant systems including Equinox, Adin, Straumann and Osstem for over a decade, and offers complete fixed teeth on implants.',
                duration: 60,
                price: 0,
                modes: ['in-person'],
                ...
                featured: true,
                active: true,
                doctors: ['anupam-purwar']
            },
            {
                id: 'root-canal',
                name: 'Root Canal Treatment',
                tagline: 'Rotary, precise and almost painless',
                description: 'Infected nerve tissue is removed, cleaned and sealed with gutta-percha or resin cements. The clinic has fully adopted rotary root canal treatment, using an integrated endomotor from Ionyx (France), Endoactivator from Dentsply (USA), cleaning solutions from Septodont (France) and filling material from Ivoclar Vivadent (Germany).',
                duration: 60,
                price: 0,
                modes: ['in-person'],
                ...
                featured: true,
                active: true,
                doctors: ['shally-khanna', 'anupam-purwar']
            },
            {
                id: 'cosmetic-dentistry',
                name: 'Cosmetic Dentistry',
                tagline: 'Smile design with extensive mock-up and try-in',
                description: 'Crooked, discoloured, fractured or spaced teeth are treated after full diagnosis and planning, including mock preparation and aesthetic try-in so you can see the final result before treatment begins. Materials and equipment from Ivoclar (Germany), Shofu (Japan) and Dentsply (USA).',
                duration: 45,
                price: 0,
                modes: ['in-person'],
            ...
            },
            {
                ...
                tagline: 'Correcting irregular and mal-positioned teeth',
                description: 'Correction of irregular and mal-positioned teeth with metal braces, ceramic braces and clear aligners. Treatment typically runs one and a half to two years with highly predictable results, carried out by dedicated orthodontists at the clinic.',
                duration: 45,
                price: 0,
                modes: ['in-person'],
                ...
                featured: true,
                active: true,
                doctors: ['consultant-orthodontist']
            },
            {
                id: 'prosthodontics',
                name: 'Crowns, Bridges & Dentures',
                tagline: 'Fixed and removable replacements for missing teeth',
                description: 'Fixed prosthodontics in all-ceramic, metal-ceramic or all-metal, plus complete dentures and cast partial dentures. All-ceramic crowns are advised for front teeth for their appearance, while monolithic zirconia is frequently used for back teeth.',
                duration: 60,
                price: 0,
                modes: ['in-person'],
            ...
            },
            {
                ...
                tagline: 'Cleaning, polishing and gum care',
                description: 'Cleaning and polishing of teeth, gum care and flap surgeries, including local drug delivery and advanced flap procedures, using equipment from NSK (Japan) and Hu-Friedy (Germany). Child dentistry, from fluoride application and sealants to pulpectomy and stainless steel crowns, is also provided.',
                duration: 30,
                price: 0,
                modes: ['in-person'],
            ...
            },
            {
                ...
                tagline: 'Unhurried examination and treatment planning',
                description: 'A detailed examination and diagnosis, with an appointment system built around giving you ample time and near-zero waiting, so that a proper treatment plan can be made.',
                duration: 30,
                price: 0,
                modes: ['in-person'],
                image: 'assets/img/gen_service-image-1.jpg',
                ...
                featured: true,
                active: true,
                doctors: ['anupam-purwar', 'shally-khanna', 'consultant-orthodontist', 'consultant-oral-surgeon']
            },
            {
                id: 'follow-up',
                name: 'Follow-up Consultation',
                tagline: 'Post-treatment progress review',
                description: 'A review visit after treatment to check healing, comfort and ongoing oral health.',
                duration: 15,
                price: 0,
        ...
        blogs: [
            ...
            },
            {
                ...
                author: 'Consultant Orthodontist',
                date: 'April 22, 2026',
            ...
            },
            {
                ...
                category: 'Preventive Care',
                author: 'Consultant Oral Surgeon',
                date: 'April 15, 2026',
        ...
        reviews: [
            {
                ...
                rating: 5,
                comment: "“I’ve always been nervous about visiting the dentist, but Dr. Anupam's Town Dental changed everything. The staff is warm, and the care is exceptional. I finally enjoy smiling again.”",
            ...
            },
            {
                ...
                doctorId: 'consultant-orthodontist',
            ...
            },
            {
                ...
                rating: 5,
                comment: '“Very clean clinic with modern equipment. Dr. Anupam Purwar explained the root canal step by step and there was virtually zero pain. Outstanding experience in Bareilly.”',
                avatar: 'assets/img/gen_testimonial-author-1.jpg',
                doctorId: 'anupam-purwar',
                serviceId: 'root-canal',
                date: '2026-08-30',
        ...
        patients: [
            ...
            },
            {
                ...
                medicalHistory: 'Orthodontic alignment in progress with Consultant Orthodontist.',
        ...
        appointments: [
            ...
            },
            {
                ...
                history: [
                    ...
                    { time: '2026-08-18T18:15:00Z', action: 'Marked Attended by Dr. Anupam Purwar', user: 'Dr. Anupam Purwar' }
                ]
            },
            {
                reference: 'DC-901A05',
        ...
        staff: [
            {
                ...
                email: 'admin@dranupamstowndental.in',
                role: 'ADMIN',
                phone: '+91 81266 43459',
                active: true,
            ...
            },
            {
                ...
                email: 'staff@dranupamstowndental.in',
                role: 'STAFF',
                phone: '+91 81266 43459',
                active: true,
        ...
        credentials: {
            'admin@dranupamstowndental.in': { password: 'admin123', role: 'ADMIN', refId: 'usr-admin-1' },
            'staff@dranupamstowndental.in': { password: 'staff123', role: 'STAFF', refId: 'usr-staff-1' },
            'dr.anupam@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'anupam-purwar' },
            'orthodontist@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'consultant-orthodontist' },
            'dr.shally@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'shally-khanna' },
            'oralsurgeon@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'consultant-oral-surgeon' },
            'admin@dranupamstowndental.in': { password: 'admin123', role: 'ADMIN', refId: 'usr-admin-1' },
            'staff@dranupamstowndental.in': { password: 'staff123', role: 'STAFF', refId: 'usr-staff-1' },
            'dr.anupam@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'anupam-purwar' },
            'orthodontist@dranupamstowndental.in': { password: 'doctor123', role: 'DOCTOR', refId: 'consultant-orthodontist' },
        ...
        auditLogs: [
            {
                ...
                action: 'INITIALIZED',
                entity: 'Database',
                details: "Dr. Anupam's Town Dental management core initialized."
            }
        ],

        settings: {
            clinicName: "Dr. Anupam's Town Dental",
    ...
    LumoraDB.prototype.compileWhatsAppMessage = function (templateKey, appt) {
        ...
        var clinicName = clinic.name || "Dr. Anupam's Town Dental";
        var clinicAddr = clinic.address || '127/89, Macnair Road, near Sood Dharam Kanta, opp. Major Nursing Home, Prem Nagar, Bareilly, Uttar Pradesh 243005';
        var clinicPh = clinic.phone || '+91 81266 43459';
        var emergPh = clinic.phone || '+91 81266 43459';
        var mapsLink = clinic.mapsUrl || 'https://maps.google.com/?cid=3426945284530272874';
